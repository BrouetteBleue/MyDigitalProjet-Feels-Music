    ...
    <div class="flex flex-col w-full">
        ...
        <div class="flex flex-col justify-center items-center rounded-xl bg-[#292929] border-[1px] border-[#3D3D3D] py-5 lg:py-16 px-3 lg:px-10">
            <div class="w-full flex flex-row">
                <input type="text" class="w-full rounded-full border-[1px] bg-transparent border-[#3D3D3D] text-[border-[#3D3D3D] lg:mr-[5%] mb-10 px-3 py-2" name="Titre" placeholder="Titre">
            </div>
            <div class="flex flex-col lg:flex-row w-full items-start justify-center">
                <div class="flex flex-col justify-start lg:w-1/2 w-full mr-2">
                    <div class="flex flex-row lg:flex-wrap justify-start mb-8">
                        <ButtonsSelect class="w-1/2 lg:w-[30%] mr-5 rounded-full" text="Catégorie"/>
                        <ButtonsSelect class="w-1/2 lg:w-[30%]" text="Style"/>
                    </div>

                    <div class="flex flex-row flex-wrap justify-center">
                        <textarea class="w-full  rounded-xl border-[1px] bg-transparent border-[#3D3D3D] text-[border-[#3D3D3D] lg:mr-[5%] mb-10 px-3 py-2 overflow-y-hidden" name="" id="" cols="30" rows="6" placeholder="Tags"></textarea> 
                    </div>

                    <div class="flex flex-row justify-between">
                        <input type="text" class="lg:w-[25%] w-1/2 lg:mx-[5%] rounded-full border-[1px] bg-transparent border-[#3D3D3D] text-[border-[#3D3D3D] text-center mr-[5%] mb-5 px-3 py-2" placeholder="Prix">
                        <ButtonsDraglink inputId="upload1" class="w-[45%] lg:flex hidden" />
                    </div>
                ...
                <div class="flex flex-row lg:w-1/2 w-full justify-start items-center ml-2">
                    ...
                    <ButtonsDraglink @file-selected="onFileSelected" :emitEvent="true" inputId="upload2" class="w-6/12"/>
                </div>

                <div class="flex lg:hidden flex-col items-end w-full my-10">
                    <span class="text-[#9CA1A1] w-full text-left text-xl font-bold mb-3">Votre fichier audio </span>
                    <ButtonsDraglink inputId="upload1" class="w-8/12" />
                </div>
            ...
            <div class="flex flex-row justify-end w-full ">
                <ButtonsAddToCartBtn v-if="props.TypeForm == 'add' " class="text-lg w-24 h-[50px] rounded-xl mx-[5%]" text="Ajouter" icon-name="Plus"/> 
